...
if __name__ == "__main__":
    ...
    Path("zap_branch2learn_global_attention_gat_b/log/").mkdir(exist_ok=True)
    log = Logger(filename="zap_branch2learn_global_attention_gat_b/log/02_train")
    ...
    #train_files = [
    #    str(path)
    #    for path in Path(f"/data/yxwu/python-moiptimiser/src/training_data_oc_sol/{PROBLEM}_{str(4)}_{str(100)}").glob(
    #        "sample_*.pkl"
    #    )
    #]#[:404915]
    #valid_files = [
    #    str(path)
    #    for path in Path(f"/data/yxwu/python-moiptimiser/src/valid_data_oc_sol/{PROBLEM}_{str(4)}_{str(100)}").glob(
    #        "sample_*.pkl"
    #    )
    #]
    ...
    #model_filename = f"/data/yxwu/python-moiptimiser/src/zap_branch2learn_global_attention_gat_b/models/{args.model}/{args.model}_{PROBLEM}.pkl"
    model_filename = f"/data/yxwu/python-moiptimiser/src/zap_branch2learn_global_attention_gat_b/models/{args.model}/{args.model}_{PROBLEM}_{'0.5size'}.pkl"
